...
class TestIntegerList(TestCase):
    def setUp(self):
        self.integer_list = IntegerList("50",
                                        1,
                                        False,
                                        3.5,
                                        2,
    ...
    def test_integer_on_valid_index_expected_inserted_element(self):
    ...
    def test_insert_element_with_invalid_index_raises_index_errors(self):
        with self.assertRaises(IndexError) as ex:
